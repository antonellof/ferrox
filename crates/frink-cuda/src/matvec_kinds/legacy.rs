...
/// mirrors `frink_quant::dot_q8_0_f32_scalar`'s math exactly (same
...
/// mirror `frink_quant::dot_q4_0_f32_scalar`'s exact math.
///
/// Verified: compiled by NVRTC and executed on a real GPU (RTX 3060),
/// matching the CPU reference exactly -- see the module doc comment.
...
/// `cargo test -p frink-cuda --features cuda -- --ignored` before any
