...
//! the Metal shape (`frink_metal::attn::launch_prefill_dense_layer`)
...
/// Pairing convention of the rotation (`frink_models::config::
...
/// rotate (`frink_models::rope_layers`): the kernel then does not run.
#[derive(Clone, Copy)]
