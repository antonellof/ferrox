...
use crate::{Q8KActivations, Q5_K_BLOCK_ELEMS};
            ...
            for sb in 0..4 {
                ...
                for cp in 0..4 {
                    ...
                    for m in 0..4 {
                        ...
                        let q5_hi = vreinterpretq_s8_u8(vorrq_u8(vshrq_n_u8(q5_qs[m], 4), hbit_hi));
        ...
        for sb in 0..4 {
            ...
            for c in 0..2 {
                ...
                for i in 0..8 {
                    ...
                    let hbit_hi = vshlq_n_u8(vandq_u8(qh[c][i], mtwo), 3);
                    qh[c][i] = vshrq_n_u8(qh[c][i], 2);
                    q5_lo[i] = vreinterpretq_s8_u8(vsliq_n_u8(vandq_u8(q5_cols, m4b), hbit_lo, 4));
                    q5_hi[i] = vreinterpretq_s8_u8(vorrq_u8(vshrq_n_u8(q5_cols, 4), hbit_hi));
                }
        ...
        for sb in 0..4 {
            ...
            for cp in 0..4 {
                ...
                for m in 0..4 {
                    ...
                    let hbit_hi = vshlq_n_u8(vandq_u8(qh[cp][m], mtwo), 3);
                    qh[cp][m] = vshrq_n_u8(qh[cp][m], 2);
                    q5_lo[m] = vreinterpretq_s8_u8(vsliq_n_u8(vandq_u8(q5_qs[m], m4b), hbit_lo, 4));
