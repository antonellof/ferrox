...
//! every real export. `frink_models::mla::MlaKvB` is the two forms as
...
//! branch, `:563-598`; `frink_core::mla_absorbed`), with the cache
...
//! | `deepseek2_yarn_v2` | the split file plus YaRN as a DeepSeek-V2 export declares it: factor 4, `original_context_length = 16`, `yarn_log_multiplier = 0.1 * 0.707` (`frink_models::mla_yarn`) |
...
//!     crates/frink-models/tests/fixtures/deepseek2_tiny.gguf
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_deepseek2_fixture.py \
//!     crates/frink-models/tests/fixtures/deepseek2_legacy_tiny.gguf --legacy-kv-b
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_deepseek2_fixture.py \
//!     crates/frink-models/tests/fixtures/deepseek2_yarn_v2_tiny.gguf --yarn 0.707
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_deepseek2_fixture.py \
//!     crates/frink-models/tests/fixtures/deepseek2_yarn_v3_tiny.gguf --yarn 1.0
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_deepseek2_fixture.py \
//!     crates/frink-models/tests/fixtures/deepseek2_yarn_legacy_tiny.gguf --yarn 0.707 --legacy-kv-b
...
use frink_models::mla::{MlaKvB, MlaQProj};
use frink_models::{load_mla_engine_from_path, LoadError, MlaEngine, MlaLayerFfn, ServedEngine};
