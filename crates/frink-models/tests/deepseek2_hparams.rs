//! The `deepseek2` MLA hparam contract: does frink's loader ask for
...
use frink_models::mla_gguf_loader::read_deepseek2_hparams;
...
fn a_mistral_large_temperature_is_refused_by_name_rather_than_dropped() {
    ...
    assert_eq!(
        frink_gguf::TensorSource::metadata_f32(&file, "deepseek2.attention.temperature_scale"),
        Some(0.5)
    );
