...
//!
//! Requires:
//! - `cargo test -p frink-models --test qwen2moe_paris -- --ignored`
//! - `models/Qwen1.5-MoE-A2.7B-Chat-Q4_K_M.gguf` (or `FRINK_TEST_QWEN2MOE_GGUF`)
...
#[test]
#[ignore = "needs models/Qwen1.5-MoE-A2.7B-Chat-Q4_K_M.gguf (or FRINK_TEST_QWEN2MOE_GGUF)"]
