...
//! flag skips it. `frink_models::layer_loops` is the seam: the weights
...
//!     crates/frink-models/tests/fixtures/nanbeige_tiny.gguf
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_nanbeige_fixture.py \
//!     crates/frink-models/tests/fixtures/nanbeige_skipnorm_tiny.gguf --skip-loop-norm
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_nanbeige_fixture.py \
//!     crates/frink-models/tests/fixtures/nanbeige_loop1_tiny.gguf --loops 1
