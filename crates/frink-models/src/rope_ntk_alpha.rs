...
//! string and a different (still-refusing) frink row.
//!
...
///
/// `head_dim` is `hparams.n_embd_head_k()`, which frink carries as
...
mod tests {
    ...
    /// generically and applies it in exactly two graphs, so a frink
