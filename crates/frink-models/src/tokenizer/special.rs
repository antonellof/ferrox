...
impl SpecialTokenTable {
    ...
    pub fn from_gguf(file: &impl frink_gguf::TensorSource, id_to_token: &[String]) -> Self {
...
mod tests {
    use super::*;
    use frink_gguf::{GgufError, GgufValue, TensorInfo, TensorSource};
    ...
    /// off-by-one `frink imatrix` measured on `docs/CLI.md`.
    #[test]
