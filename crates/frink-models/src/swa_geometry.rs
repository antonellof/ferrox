...
//! WIDTH, which frink now honours; a second HEAD WIDTH, which it
...
//!    the sliding layers their own K and V widths. frink carries ONE
...
//!    engine. frink folds the frequency half of YaRN into
