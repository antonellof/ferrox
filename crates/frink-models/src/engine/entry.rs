...
//!
//! [`frink_core::par::on_workers`] turns those ~150 cold entries into
//! one, and [`frink_core::par::cold_regions`] is how a test says so
...
/// pinned` is `pub(crate)` to `frink-core` and cannot be asked
