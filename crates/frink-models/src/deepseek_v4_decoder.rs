...
//! separate from `frink-models::decoder::Decoder` (the generic GQA path
...
use frink_core::attention::apply_rope_back;
use frink_core::csa_hca_compress::compress_block;
use frink_core::deepseek_v4_attention::{csa_attention, hca_attention};
...
/// (`dsv4_append_zero_row`), and `frink_core::csa_hca_compress`'s
