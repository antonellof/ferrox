//! The accumulator behind `frink imatrix`: llama.cpp's
//! `IMatrixCollector::collect_imatrix` (`tools/imatrix/imatrix.cpp:
//! 219-399`), fed by `frink_core::activation_tap` instead of a graph
//! callback.
//!
...
//! not bit for bit. `frink imatrix --compare` prints that bound.
