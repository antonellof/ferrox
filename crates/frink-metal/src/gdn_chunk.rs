...
//!
//! `frink_core::gdn_chunk` is the definition and the oracle: same
...
//
// which is `frink_core::gdn_chunk::delta_chunk` line for line, with
...
/// (`frink_core::recurrent_state::AlignedF32`, `crate::gdn::buffer_no_copy`).
///
/// # Safety
///
