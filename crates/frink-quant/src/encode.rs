...
//! generates measurably worse text. `frink quantize` refuses every
...
mod tests {
    ...
    /// The property that makes `frink quantize`'s output a file
    ...
    fn q8_0_matches_llama_cpp_quantize_row_q8_0_ref() {
        ...
        assert_eq!(
            ...
            "frink's Q8_0 encoder disagrees with llama.cpp's"
        );
    }
