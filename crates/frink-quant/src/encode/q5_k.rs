...
/// frink has neither encoder, so this refuses instead of padding.
...
mod tests {
    ...
    /// The property that makes `frink quantize --type q5_k_m`'s output
    ...
    /// TYPE (Q5_K -> Q5_1 -> F16); frink has neither encoder, and
