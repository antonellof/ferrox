...
pub struct LayerFfnLaunches<'a> {
    norm: &'a [f32],
    norm_eps: f32,
    gate: ferrox_metal::gpu::MatvecLaunch<'a>,
    up: ferrox_metal::gpu::MatvecLaunch<'a>,
    down: ferrox_metal::gpu::MatvecLaunch<'a>,
    fold_x: Option<ferrox_metal::hadamard::FoldPlan<'a>>,
    fold_act: Option<ferrox_metal::hadamard::FoldPlan<'a>>,
}

#[cfg(feature = "metal")]
impl<'a> LayerFfnLaunches<'a> {
    pub fn as_metal(&'a self) -> ferrox_metal::gdn_branch::LayerFfn<'a> {
        ferrox_metal::gdn_branch::LayerFfn {
            norm: self.norm,
...
pub struct LayerHeadLaunches<'a> {
    norm: &'a [f32],
    norm_eps: f32,
    qkv: ferrox_metal::gpu::MatvecLaunch<'a>,
    z: ferrox_metal::gpu::MatvecLaunch<'a>,
    beta: ferrox_metal::gpu::MatvecLaunch<'a>,
    alpha: ferrox_metal::gpu::MatvecLaunch<'a>,
    fold_x: Option<ferrox_metal::hadamard::FoldPlan<'a>>,
}

#[cfg(feature = "metal")]
impl<'a> LayerHeadLaunches<'a> {
    pub fn as_metal(&'a self) -> ferrox_metal::gdn_branch::LayerHeadIn<'a> {
        ferrox_metal::gdn_branch::LayerHeadIn {
            norm: self.norm,
            norm_eps: self.norm_eps,
            qkv: &self.qkv,
            z: &self.z,
