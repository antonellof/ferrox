...
//! it (`ferrox_core::weight_matrix::hadamard`).
//!
...
//! qwen3next); ferrox's route is `WeightMatrix::apply`, which every
...
use ferrox_core::weight_matrix::hadamard::{FoldSite, HadamardFold, HeadPerm};
