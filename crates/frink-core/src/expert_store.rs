...
//! behind the server's `FRINK_EXPERT_CACHE_BYTES` or
//! `FRINK_SSD_STREAMING=1` which defaults the cache to 2 GiB), each
//! proven
...
mod tests {
    ...
    fn weight_matrix_over_a_lease_computes_identically_and_extends_the_pin() {
        ...
        for r in 0..rows {
            packed.extend(frink_quant::quantize_q8_0(
