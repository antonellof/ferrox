...
//! through [`frink_models::grammar::json_schema`] -- the same converter
...
//! # Lazy, and mandatory
//!
//! The grammar is LAZY (see [`frink_models::grammar::lazy`]), triggered
...
fn schema_refused(tool: &str, err: &frink_models::grammar::SchemaError) -> ApiError {
    invalid(
        format!(
